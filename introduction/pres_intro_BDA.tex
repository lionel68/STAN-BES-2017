...
\note{
 ...
 \end{frame}
  ...
  Bayesian data analysis update prior knowledge (or belief) based on new data.
...
\section{How?}
 ...
 \begin{frame}
  ...
  \begin{columns}
   \column{.5\textwidth}
   Using special probability language:
   \begin{itemize}
    \item JAGS via rjags
    \item STAN via rstan
   \end{itemize}
   ...
   \column{.5\textwidth}
   Using packages that translate R formula into probability language:
   \begin{itemize}
    \item rstanarm
    \item brms
   \end{itemize}
